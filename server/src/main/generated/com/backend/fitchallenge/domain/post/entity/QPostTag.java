...
public class QPostTag extends EntityPathBase<PostTag> {
    ...
    private static final long serialVersionUID = -37899576L;
    ...
    public final com.backend.fitchallenge.domain.tag.domain.QTag tag;
    ...
    public QPostTag(Class<? extends PostTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tag = inits.isInitialized("tag") ? new com.backend.fitchallenge.domain.tag.domain.QTag(forProperty("tag")) : null;
    }
