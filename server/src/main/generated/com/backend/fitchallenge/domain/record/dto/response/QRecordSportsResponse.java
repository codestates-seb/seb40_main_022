...
public class QRecordSportsResponse extends ConstructorExpression<RecordSportsResponse> {
    ...
    public QRecordSportsResponse(com.querydsl.core.types.Expression<Long> sportsId, com.querydsl.core.types.Expression<com.backend.fitchallenge.domain.sports.entity.Sports.BodyPart> bodyPart, com.querydsl.core.types.Expression<String> name, com.querydsl.core.types.Expression<Integer> set, com.querydsl.core.types.Expression<Integer> count, com.querydsl.core.types.Expression<Integer> weight) {
        super(RecordSportsResponse.class, new Class<?>[]{long.class, com.backend.fitchallenge.domain.sports.entity.Sports.BodyPart.class, String.class, int.class, int.class, int.class}, sportsId, bodyPart, name, set, count, weight);
    }
