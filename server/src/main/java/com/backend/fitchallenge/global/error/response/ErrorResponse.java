package com.backend.fitchallenge.global.error.response;
...
public class ErrorResponse {
    ...
    private List<ConstraintViolationError> violationErrorList;
    ...
    private ErrorResponse(List<FieldError> fieldErrorList, List<ConstraintViolationError> violationErrorList) {
        this.fieldErrorList = fieldErrorList;
        this.violationErrorList = violationErrorList;
    }
